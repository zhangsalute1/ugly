  ...
  <div class="container">
    ...
    <svg viewBox="-100 -100 200 200" xmlns="http://www.w3.org/2000/svg" width="500" height="500" id="face-svg">
      ...
      <g :transform="'translate(' +
            ...
            ')'
            ">
        <polyline id="rightUpper" :points="eyeRightUpper" fill="none" stroke="black" :stroke-width="3.0 / faceScale"
          stroke-linejoin="round" filter="url(#fuzzy)" />
        <polyline id="rightLower" :points="eyeRightLower" fill="none" stroke="black" :stroke-width="4.0 / faceScale"
          stroke-linejoin="round" filter="url(#fuzzy)" />
      ...
      <g :transform="'translate(' +
            ...
            ')'
            ">
        <polyline id="leftUpper" :points="eyeLeftUpper" fill="none" stroke="black" :stroke-width="4.0 / faceScale"
          stroke-linejoin="round" filter="url(#fuzzy)" />
        <polyline id="leftLower" :points="eyeLeftLower" fill="none" stroke="black" :stroke-width="4.0 / faceScale"
          stroke-linejoin="round" filter="url(#fuzzy)" />
      ...
      <g id="hairs">
        <polyline v-for="(hair, index) in hairs" :key="index" :points="hair" fill="none" :stroke="hairColor"
